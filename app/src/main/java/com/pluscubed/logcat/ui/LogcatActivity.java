...
public class LogcatActivity extends AppCompatActivity implements FilterListener, LogLineViewHolder.OnClickListener {
    ...
    public void onClick(final View itemView, final LogLine logLine) {
        if (partialSelectMode) {
            ...
            mHandler.post(() -> mLogListAdapter.notifyItemChanged(binding.list.getChildAdapterPosition(itemView)));
    ...
    private void openLogFile(final String filename) {
        ...
        final AsyncTask<Void, Void, List<LogLine>> openFileTask = new AsyncTask<Void, Void, List<LogLine>>() {
            ...
            protected void onPreExecute() {
                ...
                showProgressBar();
                binding.mainProgressBar.enableIndeterminateMode(false);
            }
            ...
            protected List<LogLine> doInBackground(Void... params) {
                ...
                for (int lineNumber = 0, linesSize = lines.size(); lineNumber < linesSize; lineNumber++) {
                    ...
                    runOnUiThread(() -> binding.mainProgressBar.setProgress(finalLineNumber * 100 / linesSize));
                }
    ...
    private void showProgressBar() {
        ...
        binding.mainProgressBar.setColor(colorScheme.getSelectedColor(this));
    ...
    private void updateBackgroundColor() {
        ...
        mHandler.post(() -> binding.mainBackground.setBackgroundColor(color));
    ...
    private class LogReaderAsyncTask extends AsyncTask<Void, LogLine, Void> {
        ...
        protected void onPreExecute() {
            ...
            showProgressBar();
            binding.mainProgressBar.enableIndeterminateMode(true);
        }
